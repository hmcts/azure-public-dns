recordsets = [
  ...
  { name = "@", records = ["mail.contact.justice.sandbox.platform.hmcts.net 0"], ttl = 300, type = "MX" },
  ...
  { name = "contact.justice", records = ["ctscmail.sandbox.platform.hmcts.net 10"], ttl = 3600, type = "MX" },
  ...
  { name = "cdnverify.plum", records = ["cdnverify.hmcts-plum-shutter-sbox.azureedge.net"], ttl = 3600, type = "CNAME" },
