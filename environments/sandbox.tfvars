...
{ name = "ctsc", records = ["ctscmail-jjdev-frontdoor.azurefd.net"], ttl = 60, type = "CNAME" },
{ name = "afdverify.ctsc", records = ["ctscmail-jjdev-frontdoor.azurefd.net"], ttl = 3600, type = "CNAME" },
...
{ name = "plum", records = ["hmcts-sbox.azurefd.net"], ttl = 300, type = "CNAME" },
